...
export default function CardEcommerce({ user }) {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden rounded bg-white text-centertext-slate-500 shadow-md shadow-slate-200">
        {/*  <!-- Image --> */}
        ...
        <div className="p-6">
          <header className="mb-4">
            <h3 className="text-xl font-medium text-slate-700">{user.name}</h3>
            <p className=" text-slate-400">
              {" "}
              {user.role || user.vehical || user.address}
            </p>
          </header>
          <p>{user.job}</p>
        </div>
