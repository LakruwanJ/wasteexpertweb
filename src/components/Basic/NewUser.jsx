...
export default function CardEcommerce({ name }) {
    return (
        <>
            ...
            <button className="overflow-hidden rounded-lg border-2 border-dashed border-slate-300 bg-white text-center text-slate-500 shadow-md shadow-slate-200 p-4 items-center">
