...
import MngSmartBin from "../main/MngSmartBin";
...
const Dispatcher = () => {
    ...
    const renderContent = () => {
        switch (selectedNavItem) {
            ...
            case "Available Collectors":
                return <div><AvailableColl /></div>;
            case "Map":
                return <div><Map /></div>;
            case "New Schedule":
                return <div><AddSchedule /></div>;
            case "New Smart Bin":
                return <div><AddSmartBin /></div>;
            case "Manage Smart Bin":
                return <div><MngSmartBin /></div>;
