...
import MngAdmin from "../main/MngAdmin";
import MngDisp from "../main/MngDisp";
import MngColl from "../main/MngColl";
...
const Admin = () => {
    ...
    const renderContent = () => {
        switch (selectedNavItem) {
            case "Dashboard":
                return <div><DashboardA /></div>;
            case "Manage Admin":
                return <div><MngAdmin /></div>;
            case "Manage Dispatchers":
                return <div><MngDisp /></div>;
            case "Manage Collectors":
                return <div><MngColl /></div>;
            case "Manage Residents":
                return <div><MngResi /></div>;
            case "Map":
                return <div><Map /></div>;
            case "View Schedules":
